...
class EndPage extends Component {
  ...
  componentDidMount () {
    ...
    if (this.props.location.pdfIndex) {
      this.setState({
        pdfpath: this.state.pdfPaths[this.props.location.pdfIndex].path,
        active: this.props.location.pdfIndex
      })
    }
  }

  componentDidUpdate(oldProps) {
    if(oldProps.location.pdfIndex!==this.props.location.pdfIndex){
      this.setState({
        pdfpath: this.state.pdfPaths[this.props.location.pdfIndex].path,
        active: this.props.location.pdfIndex
      });
